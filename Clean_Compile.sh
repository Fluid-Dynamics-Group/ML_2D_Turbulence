...
#OpenMP compiled
#f2py3 -m Fortran_functions --fcompiler=gfortran --f90flags='-fopenmp' -lgomp -c Fortran_functions.f95
#f2py3 -m Approximate_Deconvolution --fcompiler=gfortran --f90flags='-fopenmp' -lgomp -c Approximate_Deconvolution.f95
#f2py3 -m Multigrid_solver --fcompiler=gfortran --f90flags='-fopenmp' -lgomp -c Multigrid_solver.f95
